...
export const photos: Photo[] = [
  ...
  { slug: 'love-06', category: 'love-story', sourceFile: 'SnapInsta.to_658571333_18013061513836533_777481571487651401_n.jpg', width: 720, height: 960, alt: { ru: 'Коллаж: пара у книжных полок и чёрно-белые объятия в библиотеке', en: 'Collage: a couple by the bookshelves and a black-and-white embrace in the library' } },
  ...
  { slug: 'love-21', category: 'love-story', sourceFile: 'SnapInsta.to_684843279_18016284212836533_4094334937703427035_n.jpg', width: 587, height: 733, alt: { ru: 'Сцепленные руки пары через окно машины под дождём', en: "A couple's clasped hands through a rain-streaked car window" } },
  { slug: 'love-22', category: 'love-story', sourceFile: 'SnapInsta.to_684855309_18017189345836533_2113241894251156481_n.jpg', width: 589, height: 588, alt: { ru: 'Деталь: жемчужное колье среди розовых кустов', en: 'Detail: a pearl necklace among rose bushes' } },
  ...
  { slug: 'love-24', category: 'love-story', sourceFile: 'SnapInsta.to_685386164_18017189405836533_175695731233902322_n.jpg', width: 720, height: 900, alt: { ru: 'Коллаж: отдых среди роз, деталь книги, поцелуй в листве', en: 'Collage: resting among roses, a book detail, a kiss in the leaves' } },
  ...
  { slug: 'love-27', category: 'love-story', sourceFile: 'SnapInsta.to_687284927_18017189387836533_3293444089339232783_n.jpg', width: 720, height: 900, alt: { ru: 'Коллаж: пара с розой в теплице, романтичный поцелуй', en: 'Collage: a couple with a rose in the greenhouse, a romantic kiss' } },
  ...
  { slug: 'portrait-04', category: 'portrait', sourceFile: 'SnapInsta.to_750086049_18027194873836533_6795609942903314071_n.jpg', width: 691, height: 462, alt: { ru: 'Мужчина у туфовой стены с оконными проёмами', en: 'A man by a tuff-stone wall with window openings' } },
  { slug: 'portrait-05', category: 'portrait', sourceFile: 'SnapInsta.to_750255781_18027195026836533_7800854702609093709_n.jpg', width: 476, height: 713, alt: { ru: 'Мужчина на лестнице заброшенной постройки среди зелени', en: 'A man on the stairs of an abandoned structure among greenery' } },
 ...
 * copy-photos.mjs trims it off when copying into public/. Trimmed pixel
 * dimensions are recorded directly on each Photo entry above.
 */
